        ...
        >
          ...
          >
            ...
            <Box display='flex' flexDirection='column' justifyContent='flex-end' color='white' w='100%' h='100%' p='0' textAlign='justify'>
              <Box bg='rgba(0,0,0,0.6)' h='120px' overflow='hidden' pl='10px' pr='10px'  style={{filter:'box-shadow(0px,0px,10px,10px rgba(0,0,0,0.5))'}} fontSize='13px'><Box fontSize='1.2rem' mt='10px' color='white' mb='5px'>Bhagavad Gita 3.35:<Box h='2px' w='100%' bg={theme.colors.col.text} mt='-2px'></Box></Box><q>It is better to perform one's own duties imperfectly than to master the duties of another. By fulfilling the obligations he is born with, a person never comes to grief</q></Box>
            </Box>
          </Box>
          ...
          >
            ...
            <Box display='flex' flexDirection='column' justifyContent='flex-end' color='white' w='100%' h='100%' p='0' textAlign='justify'>
              <Box bg='rgba(0,0,0,0.6)' h='120px'overflow='hidden' pl='10px' pr='10px'  style={{filter:'box-shadow(0px,0px,10px,10px rgba(0,0,0,0.5))'}} fontSize='13px'><Box fontSize='1.2rem' mt='10px' color='white' mb='5px'>Bhagavad Gita 2.47:<Box h='2px' w='100%' bg={theme.colors.col.text} mt='-2px'></Box></Box><q>You have a right to perform your prescribed duties, but you are not entitled to the fruits of your actions.</q></Box>
            </Box>
          </Box>
          ...
          >
            ...
            <Box display='flex' flexDirection='column' justifyContent='flex-end'  color='white' w='100%' h='100%' p='0' textAlign='justify'>
              <Box bg='rgba(0,0,0,0.6)' h='120px'overflow='hidden' pl='10px' pr='10px'  style={{filter:'box-shadow(0px,0px,10px,10px rgba(0,0,0,0.5))'}} fontSize='13px'><Box fontSize='1.2rem' mt='10px' color='white' mb='5px'>Bhagavad Gita 9.92:<Box h='2px' w='100%' bg={theme.colors.col.text} mt='-2px'></Box></Box><q>To those who are constantly devoted and who worship Me with love, I give the understanding by which they can come to Me.</q></Box>
            </Box>
          </Box>
