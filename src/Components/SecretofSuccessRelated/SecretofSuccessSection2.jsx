  ...
  return (
    <>
      <Box>
        ...
        >
          {/* prnciplesSection */}
          <Box w={{ base: "90%", md: "95%", lg: "90%", xl: "65%" }} mt="70px">
            <Heading mb="30px" fontSize={{ base: "2rem", md: "3rem" }}>
              Principles of{" "}
            ...
            >
              ...
              >
                <Box
                  ...
                  pr="10px"
                  style={{
                    filter: "box-shadow(0px,0px,10px,10px rgba(0,0,0,0.5))",
                  }}
                  fontSize="13px"
                >
                  <Box fontSize="1.2rem" mt="10px" color="white" mb="5px">
                    Bhagavad Gita 3.35:
                    <Box
                      h="2px"
                      w="100%"
                  ...
                  <q>
                    It is better to perform one's own duties imperfectly than to
                    master the duties of another. By fulfilling the obligations
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <q>
                    To those who are constantly devoted and who worship Me with
              ...
              >
                ...
                >
                  ...
                  <q>
                    ...
                    prolonged practice of yoga receives such knowledge within
