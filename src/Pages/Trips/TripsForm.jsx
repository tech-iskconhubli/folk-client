...
import {  postTripsFormData } from '../../Redux/app/action';
const TripsForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(postTripsFormData(formData))
        .then(res=>{
            console.log("res", res)
        })
            ...
            <Box width={["95%","","90%","80%","100%"]} m={"auto"}   display={["","","","flex"]} gap={"20px"} >
                ...
                <Box position={"related"} width={["","","","60%"]} boxSizing='border-box' p={["","","","20px 0px 0px 20px"]}>
                    ...
                    <Box boxSizing='border-box' p={["","","",""]}>
                        <Heading fontFamily={"form"} fontWeight={"500"} m={"30px 0px 15px 0px"}>Trips form </Heading>
                        ...
                        <Box width={["","","","500px"]}>
                            <Text m={"30px 0px 15px 0px"} fontSize={"22px"} fontWeight={"600"}>Trips form</Text>
