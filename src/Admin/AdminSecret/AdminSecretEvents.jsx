...
import { getSecretDataBasedOnLocationAndUsers } from '../../Redux/app/action';
import theme from "../../theme";

const AdminSecretEvents = () => {
  ...
  const store = useSelector((store) => store.AppReducer.adminGetSecretDataBasedOnLocation);

  useEffect(() => {
    dispatch(getSecretDataBasedOnLocationAndUsers())
    .then(res=>{
        console.log(res)
    })
  }, [dispatch]);
...
export default AdminSecretEvents;
