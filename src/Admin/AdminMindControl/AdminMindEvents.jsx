...
import { getMindDataBasedOnLocationAndUsers } from '../../Redux/app/action';
import theme from "../../theme";

const AdminMindEvents = () => {
  ...
  const store = useSelector((store) => store.AppReducer.adminMindControlDataBasedOnLocation);

  useEffect(() => {
    dispatch(getMindDataBasedOnLocationAndUsers())
    .then(res=>{
        console.log(res)
    })
  }, [dispatch]);
...
export default AdminMindEvents;
