...
import { getArtOfMindFormData, getYogaFormData } from '../../../Redux/app/action';

const UsersArtChart = () => {
  const dispatch = useDispatch();
  const store = useSelector(state => state.AppReducer.artOfMindData);

  useEffect(() => {
    dispatch(getArtOfMindFormData()); // Fetch data when component mounts
  }, [dispatch]);
