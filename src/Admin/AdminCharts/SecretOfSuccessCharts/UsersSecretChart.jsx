...
import { getSecretOfSuccessFormData } from '../../../Redux/app/action';

const UsersSecretChart = () => {
  const dispatch = useDispatch();
  const store = useSelector(state => state.AppReducer.secretData);

  useEffect(() => {
    dispatch(getSecretOfSuccessFormData()); // Fetch data when component mounts
  }, [dispatch]);
...
export default UsersSecretChart;
